...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'request_id' => ['type' => 'biginteger', 'length' => 19, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'fk_messages_people1' => ['type' => 'index', 'columns' => ['sender_id'], 'length' => []],
            'fk_messages_messages1' => ['type' => 'index', 'columns' => ['parent_id'], 'length' => []],
            'fk_messages_attachments1' => ['type' => 'index', 'columns' => ['attachment_id'], 'length' => []],
    ...
    public $records = [
        [
            ...
            'parent_id' => 1,
            'attachment_id' => 1,
            'created' => '2018-01-06 00:24:54',
            'modified' => '2018-01-06 00:24:54',
            'deleted' => 1
        ],
    ];
}
