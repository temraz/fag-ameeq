 ...
 * @var \App\Model\Entity\UsersWallet[]|\Cake\Collection\CollectionInterface $usersWallet
 */
?>
...
<div class="usersWallet index large-9 medium-8 columns content">
    <h3><?= __('Users Wallet') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($usersWallet as $usersWallet): ?>
            <tr>
